...
public class MyDateUtil {
	    ...
	    public static int compareMonthsShortRate(Date date1, Date date2){
	        int year1 = getFieldValue(date1,MyDateUtil.YEAR);//date1年份
	        int month1 = getFieldValue(date1,MyDateUtil.MONTH);//date1月份
	        int day1 = getFieldValue(date1,MyDateUtil.DAY);//date1日期
	        int hour1 = getFieldValue(date1,MyDateUtil.HOUR);//date1小时
	        int year2 = getFieldValue(date2,MyDateUtil.YEAR);//date2年份
	        int month2 = getFieldValue(date2,MyDateUtil.MONTH);//date2月份
	        int day2 = getFieldValue(date2,MyDateUtil.DAY);//date2日期
	        int hour2 = getFieldValue(date2,MyDateUtil.HOUR);//date2小时
	    ...
	    public static void main(String[] args) throws ParseException {
	        ...
	        Date date = MyDateUtil.strToDate(dateStr);

	        System.out.println("DateUtils.now(DateUtils.MONTH)="
	                + MyDateUtil.dateToStr(MyDateUtil.now(MyDateUtil.MONTH), MyDateUtil.YToSec));
	        System.out.println("DateUtils.now(DateUtils.DAY)="
	                + MyDateUtil.dateToStr(MyDateUtil.now(MyDateUtil.DAY), MyDateUtil.YToSec));
	        System.out.println("DateUtils.trunc(date, DateUtils.DAY)="
	                + MyDateUtil.dateToStr(MyDateUtil.trunc(date, MyDateUtil.DAY), MyDateUtil.YToSec));
	        System.out.println("DateUtils.trunc(date, DateUtils.HOUR)="
	                + MyDateUtil.dateToStr(MyDateUtil.trunc(date, MyDateUtil.HOUR), MyDateUtil.YToSec));
	        System.out.println("DateUtils.trunc(date, DateUtils.MINUTE)="
	                + MyDateUtil.dateToStr(MyDateUtil.trunc(date, MyDateUtil.MINUTE), MyDateUtil.YToSec));
	    }
